...
public class CustomerMainScreen extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orders.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                CustomerOrderDetails.orderID = Integer.parseInt(String.valueOf(((TextView) view.findViewById(R.id.id)).getText().toString().split("№")[1]));
                Intent intent = new Intent(CustomerMainScreen.this, CustomerOrderDetails.class);
        ...
        imageView5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerMainScreen.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        button6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustomerMainScreen.this, CustomerMakeOrder.class);
                startActivity(intent);
            }
        });
    }
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ListAdapter adapter = new SimpleAdapter(
                            CustomerMainScreen.this, ordersList,
