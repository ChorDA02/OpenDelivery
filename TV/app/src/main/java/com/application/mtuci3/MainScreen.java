...
public class MainScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderz = (GridView) findViewById(R.id.gridView);
        orderz.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    MainScreen.orderz.setAdapter(adapter);
                }
            });
        }
